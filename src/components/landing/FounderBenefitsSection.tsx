...
import { Crown, Mic, MessageCircle } from "lucide-react";
          ...
          <div className="mt-10 space-y-4 text-left">
            {benefits.map((b, i) => (
              <motion.div
                ...
                className="flex items-start gap-3 rounded-xl bg-accent/5 border border-accent/10 px-5 py-4"
              >
                <b.icon size={20} className="shrink-0 text-accent mt-0.5" />
