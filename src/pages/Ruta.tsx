...
import { Lock, CheckCircle2, Play, BookOpen, Target, Zap } from "lucide-react";
...
const modules: Module[] = [
  {
    id: 1, title: "Inmersión Cultural", desc: "Rompe creencias. Adopta la mentalidad soberana.", weeks: 4, locked: false, completed: true,
    sessions: [
  ...
  {
    id: 2, title: "Bases de Autonomía Digital", desc: "Construye tu ecosistema de herramientas propio.", weeks: 4, locked: false, completed: false,
    sessions: [
  ...
  {
    id: 3, title: "IA Aplicada al Negocio", desc: "Genera ingresos con ejecución técnica de alto nivel.", weeks: 4, locked: true, completed: false,
    sessions: [
  ...
  {
    id: 4, title: "Despliegue y Escala", desc: "Lanza tu servicio digital y genera ingresos online.", weeks: 4, locked: true, completed: false,
    sessions: [
