      ...
      >
        ...
        {mode === "login" ? (
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button type="button" onClick={handleGoogleLogin} className="flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-muted/50 py-3 text-sm font-medium transition-all hover:bg-muted">
